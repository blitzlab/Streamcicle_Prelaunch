"""
Django settings for streamcicle_prelaunch project.
...
SECRET_KEY = env('SECRET_KEY') #'7%637%+bzn69gv!+n7%^5etv6*rjq_&1u2shvy(4x@&1ox02i_'
...
ROOT_URLCONF = 'Streamcicle_Prelaunch.urls'
...
WSGI_APPLICATION = 'Streamcicle_Prelaunch.wsgi.application'
...
AUTH_USER_MODEL = 'accounts.StreamcicleSubscribers'
